...
namespace ChemicalLibrary
{
    public class CrestPipelineIncident
    {
        ...
        private string _name4, _name5, _contactnumber4, _contactnumber5, _location4, _location5, _calldate, _calltime, _ersoperator, _initials, _notificationdate, _notificationtime, _Drill, _date;
            ...
            using (SqlConnection cn = new SqlConnection(constring))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(strsql, cn))
                {
                    ...
                    while (rdr.Read())
                    {
                        ...
                        this.Directions = rdr["directions"].ToString();
                        this.City = rdr["city"].ToString();
                        this.Date = DateTime.Parse(rdr["date"].ToString()).ToString("MM/dd/yyyy");

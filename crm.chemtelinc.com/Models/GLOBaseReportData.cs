...
{
    public class GLOBaseReportData
    {
        ...
        public GLOBaseReportData()
        {
            ...
            _datreporttakendate = DateTime.Now.ToShortDateString();
            _datreporttakentime = DateTime.Now.ToString("HH:mm");
            _txtnotificationagency = "";
            _txtdischargereportedby = "";
            _txtdischargedphone1 = "";
            _txtdischargedphone2 = "(000) 000-0000";
            _datdischargedate = "";
            _datedischargetime = "";
            _txtmaterial1 = "";
            _txtmaterial2 = "";
            ...
            _dblcasun4 = "";
            _dblcasun5 = "";
            _dblamtspilled1 = "0.00";
            _dblamtspilled2 = "0.00";
            _dblamtspilled3 = "0.00";
            _dblamtspilled4 = "0.00";
            _dblamtspilled5 = "0.00";
            _txtunitrecovered1 = "";
            _txtunitrecovered2 = "";
            _txtunitrecovered3 = "";
            _txtunitrecovered4 = "";
            ...
            _dblspillamountinwater = "0.00";
            _dblspillamountinwaterunits = "";
            _memspilllocation = "";
            _dblrrcleasenumber = "N/A";
            _txtrrcleasername = "N/A";
            _txtrrcfieldname = "N/A";
            _txtlandowner = "N/A";
        ...
        public GLOBaseReportData(string constring, string id)
        {
            this.Spill_ID = id;
            ...
            using (SqlConnection cn = new SqlConnection(constring))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(strsql, cn))
                {
                    ...
                    while (rdr.Read())
                    {
                        ...
                        this.Amount_Spilled_2=rdr["dblAmtSpilled2"].ToString();
                        ...
                        this.Spill_County = rdr["wSpillCounty"].ToString();
                        this.Origin = rdr["wOrigin"].ToString();
                        this.Spill_In_Water = rdr["fSpillInWater"].ToString();
                        ...
                        this.Last_Field = rdr["memComments"].ToString();
                        this.Date_Search = DateTime.Parse(rdr["DateSearch"].ToString());
                    }
                }
            }
        }

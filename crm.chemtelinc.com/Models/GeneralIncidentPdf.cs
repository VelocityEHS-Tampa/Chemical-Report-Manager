...
{
    public class GeneralIncidentPdf
    {
        ...
        private string _dispersionofmsdsinfo, _reviewedby, _revieweddate, _sentdate, _comments, _datechanged, _username;
        ...
        public GeneralIncidentPdf(string constring, int id)
        {
            this.ID = id;
        ...
        {
            string strsql = "SELECT * FROM generalincidentreportdata WHERE id=@id";

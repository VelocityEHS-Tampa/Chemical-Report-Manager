...
namespace ChemicalLibrary
{
    public static class Delete
    {
        ...
        public static void DeleteBASFEnvironmentalIDs(string constring, BASFEnvironmentalIDs b)
        {
            string strsql = "DELETE FROM basfenvironmentals WHERE id=@id";
            using (SqlConnection cn = new SqlConnection(constring))
            {
                cn.Open();
                using (SqlCommand cmd = new SqlCommand(strsql, cn))
        ...
        public static void DeleteBASFEnvironmental(string constring, BASFEnvironmental b)
        {
            string strsql = "DELETE FROM basfenvironmental WHERE id=@id";
            using(SqlConnection cn=new SqlConnection(constring))
            {
                cn.Open();
                using (SqlCommand cmd = new SqlCommand(strsql, cn))
        ...
        public static void DeleteBASFInjuryIDs(string constring, BASFInjuryIDs b)
        {
            string strsql = "DELETE FROM basfinjuryids WHERE id=@id";
            using (SqlConnection cn = new SqlConnection(constring))
            {
                cn.Open();
                using (SqlCommand cmd = new SqlCommand(strsql, cn))
        ...
        public static void DeleteBASFInjury(string constring, BASFInjury b)
        {
            string strsql = "DELETE FROM basfinjury WHERE id=@id";
            using (SqlConnection cn = new SqlConnection(constring))
            {
                cn.Open();
                using (SqlCommand cmd = new SqlCommand(strsql, cn))
        ...
        public static void DeleteIES(string constring, IES i)
        {
            string strsql = "DELETE FROM ies WHERE id=@id";
            using (SqlConnection cn = new SqlConnection(constring))
            {
                cn.Open();
                using (SqlCommand cmd = new SqlCommand(strsql, cn))
        ...
        public static void DeleteIESContacts(string constring, IESContact i)
        {
            string strsql = "DELETE FROM iescontacts WHERE id=@i";
            using (SqlConnection cn = new SqlConnection(constring))
            {
                cn.Open();
                using (SqlCommand cmd = new SqlCommand(strsql, cn))

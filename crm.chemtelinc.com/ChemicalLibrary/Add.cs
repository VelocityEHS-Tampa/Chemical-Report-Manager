...
namespace ChemicalLibrary
{
    public static class Add
    {
        ...
        {
            string strsql = "INSERT INTO crestgeneralincidents (callername, callertitle, calleraffiliation, callerphonenumber, incidentdate, incidentlocation, incidentlatitude, incidentlongitude, incidentoccuron, incidentnature, incidentdescription, involvedname1, involvedname2, involvedname3, involvedcell1, involvedcell2, involvedcell3, involvedinjury1, involvedinjury2, involvedinjury3, weatherconditions, impactedareas, impactedbodyofwater, reporttakername, reporttakeremail, ersname1, ersname2, ersname3, erscontactnumber1, erscontactnumber2, erscontactnumber3, erslocation1, erslocation2, erslocation3, dispatcheroremployee, contractororemployee, notify911, immediatesupport, transporttohospital, emergencyresponders, fatalities, mediaonscene, incidentprivaterow, incidenttriballand, incidentblmland, incidentstateland, incidentaddress, incidentcity, incidentstate, incidentcounty, incidentintersection, incidentfacilityname, fireorexplosion, pipelinestrike, injury, illnessorexposure, vehicleaccident, spillorrelease, theft, agencyinspectionofvisit, propertydamage, potentialhazardornearmiss, landownercomplaint, impactstowater, landowner, incidenttime, incidenttimezone, calleremail, calldate, calltime, other, ersoperator, equipmentorpeople, numinjuries1, numinjuries2, numinjuries3, none, unknown, tractortrailer, equipment, dispatcheremployee, initials, county, drill, wpviolence, Incident_Contractor_Or_Employee, IndividualSafety, WeaponReported, WeaponType, FacilityOrProject, RegionOrFacility, ContractorName, FacilityOrProjectSelection, OccuredOnPipeline, NotificationDate, NotificationTime, PC_CWLocOrTransport) VALUES (@cn, @ct, @ca, @cpn, @idate, @iloc, @ilat, @ilong, @ioo, @inat, @ides, @in1, @in2, @in3, @ic1, @ic2, @ic3, @ii1, @ii2, @ii3, @wc, @ia, @ibow, @rtn, @rte, @en1, @en2, @en3, @ecp1, @ecp2, @ecp3, @el1, @el2, @el3, @doe, @coe, @n9, @isup, @tth, @er, @fat, @mos, @ipr, @itl, @ibl, @isl, @iadd, @icit, @ista, @icou, @iint, @ifn, @foe, @ps, @inj, @ill, @va, @sor, @t, @aiov, @pd, @phonm, @lc, @itw, @lown, @itim, @itimz, @cemail, @cdate, @ctime, @other, @eop, @eqop, @noi1, @noi2, @noi3, @non, @unk, @tt, @eq, @dise, @init, @county, @drill, @wpviolence, @Incident_Contractor_Or_Employee, @IndividualSafety, @WeaponReported, @WeaponType, @FOP, @ROF, @ConName, @FOPSelection, @OOP, @NotiDate, @NotiTime, @PCLOC)";
            using (SqlConnection cn = new SqlConnection(constring))
            {
                cn.Open();
                using (SqlCommand cmd = new SqlCommand(strsql, cn))
        ...
        public static void AddBASFEnvironmentalIDS(string constring, BASFEnvironmentalIDs b)
        {
            string strsql = "INSERT INTO basfenvironmentalids (id, available, [user]) VALUES (@id, @av, @us)";
            using (SqlConnection cn = new SqlConnection(constring))
            {
                cn.Open();
                using (SqlCommand cmd = new SqlCommand(strsql, cn))
        ...
        public static void AddBASFEnvironmental(string constring, BASFEnvironmental b)
        {
            string strsql = "INSERT INTO basfenvironmental (id, incidentdate, incidenttime, callername, callerphone, plantname, materialname, sdsonhand, contained, handlingcleanup, description, quantity, quantityunits, releaseto, actions, achievereportablequantity, notifications, ersoperator, calldate, calltime, nrc, peas) VALUES (@id, @ind, @int, @cn, @cp, @pn, @mn, @soh, @co, @hc, @de, @qty, @qtyu, @rt, @ac, @arq, @no, @eo, @cd, @ct, @nr, @pe)";
            using (SqlConnection cn = new SqlConnection(constring))
            {
                cn.Open();
                using (SqlCommand cmd = new SqlCommand(strsql, cn))
        ...
        public static void AddBASFInjuryIDs(string constring, BASFInjuryIDs b)
        {
            string strsql = "INSERT INTO basfinjuryids (id, available, [user]) VALUES (@id, @av, @us)";
            using (SqlConnection cn = new SqlConnection(constring))
            {
                cn.Open();
                using (SqlCommand cmd = new SqlCommand(strsql, cn))
        ...
        public static void AddBASFInjury(string constring, BASFInjury b)
        {
            string strsql = "INSERT INTO basfinjury (id, incidentdate, incidenttime, callername, callerphone, plantname, description, injurytype, bodypartaffected, escorted, immediateactions, evidencecollected, notifications, ersoperator, productname, calldate, calltime, nrc, peas) VALUES (@id, @ind, @int, @cn, @cp, @pn, @de, @it, @bpa, @es, @ia, @ec, @no, @eo, @pna, @cd, @ct, @nr, @pe)";
            using (SqlConnection cn = new SqlConnection(constring))
            {
                cn.Open();
                using (SqlCommand cmd = new SqlCommand(strsql, cn))
        ...
        public static void AddIES(string constring, IES i)
        {
            string strsql = "INSERT INTO ies (emergency, facilityname, location, address, city, state, zip, callername, callerphonenumber, contactonscenename, contactonscenephonenumber, callerunknown, contactunknown) VALUES (@em, @fn, @lo, @ad, @ci, @st, @zi, @cn, @cp, @csn, @csp, @cau, @cou)";
            using (SqlConnection cn = new SqlConnection(constring))
            {
                cn.Open();
                using (SqlCommand cmd = new SqlCommand(strsql, cn))
                {
                    ...
                    cmd.Parameters.AddWithValue("@csn", i.Contact_On_Scene_Name);
                    cmd.Parameters.AddWithValue("@csp", i.Contact_On_Scene_Phone_Number);
        ...
        public static void AddIESContact(string constring, IESContact i)
        {
            string strsql = "INSERT INTO iescontacts (name, phonenumber, priority) VALUES (@n, @p, @o)";
            using (SqlConnection cn = new SqlConnection(constring))
            {
                cn.Open();
                using (SqlCommand cmd = new SqlCommand(strsql, cn))
